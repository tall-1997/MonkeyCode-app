...
const (
	// Label holds the string label denoting the agentplugin type in the database.
	Label = "agent_plugin"
	...
	// Table holds the table name of the agentplugin in the database.
	Table = "agent_plugins"
	// RepoTable is the table that holds the repo relation/edge.
	RepoTable = "agent_plugins"
	// RepoInverseTable is the table name for the AgentPluginRepo entity.
	// It exists in this package in order to avoid circular dependency with the "agentpluginrepo" package.
	RepoInverseTable = "agent_plugin_repos"
	...
	VersionsTable = "agent_plugin_versions"
	// VersionsInverseTable is the table name for the AgentPluginVersion entity.
	// It exists in this package in order to avoid circular dependency with the "agentpluginversion" package.
	VersionsInverseTable = "agent_plugin_versions"
	// VersionsColumn is the table column denoting the versions relation/edge.
	VersionsColumn = "resource_id"
)

// Columns holds all SQL columns for agentplugin fields.
var Columns = []string{
	FieldID,
	FieldRepoID,
	FieldName,
...
func ScopeTypeValidator(st ScopeType) error {
	...
	case ScopeTypeGlobal, ScopeTypeTeam, ScopeTypeUser:
		return nil
	default:
		return fmt.Errorf("agentplugin: invalid enum value for scope_type field: %q", st)
	}
}

// OrderOption defines the ordering options for the AgentPlugin queries.
